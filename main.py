...
alg = DDPG(cfg, lr_actor=0.0001, lr_critic=0.001, buffer_size=100_000, buffer_start_size=25_000, batch_size=64, tau_polyak=0.001, save_every=5_000, eval_every=5_000)
alg.train(500_000)